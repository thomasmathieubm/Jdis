    ...
    if (input_file_next) {
      ...
      if (av[i][1] == '\0') {
        ...
        if (strcmp(av[i], OPT_HELP) == 0) {
          ...
          return r;
          //  Option -g
        } else if (strcmp(av[i], OPT_GRAPH) == 0) {
          g_opt = true;
          //  Option -p
        } else if (strcmp(av[i], OPT_PUNCT) == 0) {
          p_opt = true;
          //  Option -iVALUE
        } else if (strncmp(av[i], OPT_I, 2) == 0) {
          char *endptr;
...
void print_help(void) {
  ...
  printf(
      "        lists the FILEs in which it does or does not appear. A header line\n");
  printf(
